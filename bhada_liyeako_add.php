...
if(isset($_POST['submit']))
{
   ...
   if($bhada->save())
   {
       ...
       {
           $a=0;
           $bhada_details = new Bhadadetailstaken();
  ...
  if($a==1)
  {  
          echo alertBox("थप सफल ", "bhada_liyeako_add.php");
  }
...
<!-- js ends -->
<title>भाडामा लिएको सम्पतिको अभिलेख खाता भर्नुहोस</title>
...
<body>
    ...
    <div id="body_wrap_inner"> 
                ...
                <div class="maincontent">
                    <h2 class="headinguserprofile"> भाडामा लिएको सम्पतिको अभिलेख खाता भर्नुहोस	| <a href="dashboard_bhadadiyeko.php" class="btn">पछि जानुहोस </a> </h2>
                    <div class="OurContentFull">
                    	<h2> भाडामा लिएको सम्पतिको अभिलेख खाता भर्नुहोस		</h2>
...
<!--                           <div class="myPrint"><a href="#">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>-->
                          <div class="our_content myWidth85 myCenter">
                            ...
                            <tr>
                                <td colspan="3" class="mycenter"><legend> <b>भाडामा दिने व्यक्त्ती वा कार्यालयको विवरण:</b> </legend></td>
                            </tr>
                             <tr>
                                  ...
                                  <table class="table myWidth100 table-bordered table-responsive">
                                      <tr>
                                <td colspan="12" class="mycenter"><legend> <b>भाडामा लिएको सामानको विवरण:</b> </legend></td>
                                 </tr>
                                  <tr >
                                                  <th class="myWidth5" >क्र.स.</th>
                                                  <th class="mycenter">सामानको किसिम</th>
                                                    <th class="myWidth5">सामानको  नाम </th>
                                                   <th class="myWidth5">भाडामा लिएको सामानको मूल्य</th>
                                                  <th class="mycenter">भाडाको इकाई</th>
                                                  <th>प्रति इकाई अवधि भाडा दर</th>
                                                 <th>भाडा अवधीको परिमाण</th>
                                                 <th> भाडामा लिने सामानको परिमाण</th>
                                                ...
                                                <input type="hidden" value="2" id="category-1">
                                                  ...
                                                  <td><label><input class="form-control fill_height" type="text" name="period_rate[]" id="period_rate_1" length="15px"required></label></td>
                                                  <td><label><input class="myWidth100input fill_height" type="text" name="period[]"  id="period_1" required/></label></td>
                                                  <td><label><input class="qty_check myWidth100input fill_height" type="text" name="qty[]" id="qty_1" required/></label></td>
                                                  <td><label><input class="qty_check myWidth100input fill_height" type="text" name="bhada_amount[]" id="bhada_amount_1" required/></label></td>
                                                  <td>
                                                  ...
                                                  <td> <input class="form-control fill_height" type="text" name="end_date[]" id="nepaliDate50" required></td>
                                                  
                                                </tr>
                         
                                                <tbody id="get_bhada_div_taken">
                                                    
                                                </tbody>
                                </table>
                                    <table class="table borderless table-responsive">
                                                <tr>
                                                    <td class="myCenter"><div class="add_more_bhada_taken btn ">थप्नुहोस</div> </td>
                                                    <td class="myCenter"> <div class="remove_more_bhada_taken btn">हटाउनुहोस</div></td>
                                                </tr>
                                           </table>
