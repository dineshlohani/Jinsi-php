...
{
    $sql="select * from bhada_taken";
    $sql.=" where enlist_id={$_GET['enlist_id']}";
    $ledger= Bhadataken::find_by_sql($sql);
...
if(isset($_POST['submit']))
{
    ...
    foreach($_POST['return_amt'] as $key=>$datas)
    {
        ...
        if(!empty($data))
        {
            $ledger_details = Bhadadetailstaken::find_by_id($key);
            $ledger_profile = Bhadataken::find_by_id($ledger_details->bhada_id);
        ...
        if(($ledger_details->qty-$ledger_details->return_qty) >= $data)
            {
              ...
              {
                  $ledger_history                    = new Bhadareturnhistorytaken();
        ...
        if($a==1)
        {
          echo alertBox("थप सफल ","bhada_liyeako_return.php");  
        } 
    	...
    	<div class="">
            <div class="">
                <div class="maincontent">
                    <h2 class="headinguserprofile">भाडामा लिईएको सामान फिर्ता गर्नुहोस | <a href="index.php" class="btn">पछि जानुहोस</a> </h2>
                                                 ...
                                                 <td colspan="11">
                                                    <div class="inputWrap">
                                                         <div class="our_content">
                                                            <fieldset> 
                                                                <legend>भाडामा सामान दिने छान्नुहोस् </legend>
                                                                 <div class="titleInput"><b> सामान दिने  :</b></div>
                             ...
                             <table class="table table-bordered td1">
                                 <br><div class="titleInput"><b>सामान फिर्ता गर्ने मिती  :</b>   </div>
                                       <tr>
                                        ...
                                        <?php if(!empty($enlist_selected)): ?>      
                                              <h3><b>समान भाडामा दिने:  <?= $enlist_selected->name ?></b></h3>
                                        <?php endif; ?>     
                                          </th>
                                            ...
                                            <tr>
                                                  ...
                                                  <th class="myCenter">भाडामा लिएको मिती</th>
                               ...
                               if(!empty($ledger)):
                                   $i=1;foreach($ledger as $data1): 
                                      $ledger_details = Bhadadetailstaken::find_by_bhada_id($data1->id); 
                                   $count= count($ledger);
                                   if($count>1)
                                   {
                                       $j=$j;
