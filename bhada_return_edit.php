    	...
    	<div class="">
            <div class="">
                <div class="maincontent">
                    <h2 class="headinguserprofile">भाडामा दिईएको समान फिर्ता हटाउनुहोस्  | <a href="index.php" class="btn">पछि जानुहोस</a> </h2>
                                       ...
                                       ?>
                                             <tr>
                                               <td class=" myCenter"><?= $item_condition->name ?></td>
                                                ...
                                                <td class="mycenter"><a class="btn" href="bhada_return_delete.php?id=<?= $return->id ?>&detail_id=<?= $ledger_details->id ?>">हटाउनुहोस् </a></td>
