...
<body>
    ...
    <div id="body_wrap_inner"> 
                ...
                <div class="maincontent">
                    <h2 class="headinguserprofile"> भाडामा दिएको सम्पतिको अभिलेख खाता हेर्नुहोस	| <a href="dashboard_bhadadiyeko.php" class="btn">पछि जानुहोस </a> </h2>
...
<!--                           <div class="myPrint"><a href="#">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>-->
                          <div class="our_content myWidth85 myCenter">
                              <div class="myPrint"><a href="bhadadiyeko_print.php?enlist_id=<?= $_GET['enlist_id'] ?>&khata_number=<?= $_GET['khata_number'] ?>" target="_blank">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>
                                     ...
                                     ?>         
                                                ...
                                                <input type="hidden" value="2" id="category-1">
                                                  ...
                                                  <td class="myWidth5">  <?php if(empty($return_result))
                                                      {?> 
                                                      <a class="btn " href="bhada_edit_dashboard.php?id=<?= $data->id ?>&id_return=1">हटाउनुहोस्</a>
                                                <?php  }
                                                      else
                                                      { ?>
                                                       <a class="btn" href="bhada_edit_dashboard.php?id=<?= $data->id ?>&id_return=2">हटाउनुहोस्</a>
                                                <?php } ?></td>
                                                </tr>
                             <?php $i++; endforeach;
                             endforeach;
