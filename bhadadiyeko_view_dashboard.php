...
$sql= "select * from bhada group by khata_number asc";
...
<body>
    ...
    <div id="body_wrap_inner"> 
                ...
                <div class="maincontent">
                    <h2 class="headinguserprofile"> भाडामा दिएको अभिलेख किताब हेर्नुहोस	| <a href="dashboard_bhadaliyeko.php" class="btn">पछि जानुहोस </a> </h2>
                    <div class="OurContentFull">
                    	<h2> भाडामा दिएको  अभिलेख किताब भर्नुहोस	</h2>
                        <div class="userprofiletables">
                        
                          <table class="table table-bordered table-responsive myWidth80 box_center">
                              <tr>
                                  <th>अविलेख खाता नं  </th>
                                  <th>भाडामा लाग्नेको नाम</th>
                                  <th>ठेगाना</th>
                                  <th>सम्पर्क न</th>
                                  <th>विवरण</th>
                              </tr>
                      <?php foreach($bhada as $data): 
                          ...
                          ?>
                              <tr>
                                  ...
                                  <td><a class="btn" href="bhadadiyeko_view.php?enlist_id=<?= $data->enlist_id ?>&khata_number=<?= $data->khata_number ?>">विवरण हेर्नुहोस</a></td>
                              </tr>
                      <?php endforeach; ?>        
                          </table>
