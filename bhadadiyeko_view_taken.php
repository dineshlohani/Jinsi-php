...
$sql= "select * from bhada_taken where enlist_id={$enlist_id}";
...
<!-- js ends -->
<title>भाडामा लिएको सम्पतिको अभिलेख खाता हेर्नुहोस</title>
...
<body>
    ...
    <div id="body_wrap_inner"> 
                ...
                <div class="maincontent">
                    <h2 class="headinguserprofile"> भाडामा लिएको सम्पतिको अभिलेख खाता हेर्नुहोस	| <a href="dashboard_bhadadiyeko.php" class="btn">पछि जानुहोस </a> </h2>
                    <div class="OurContentFull">
                    	<h2> भाडामा लिएको सम्पतिको अभिलेख खाता हेर्नुहोस		</h2>
...
<!--                           <div class="myPrint"><a href="#">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>-->
                          <div class="our_content myWidth85 myCenter">
                              <div class="myPrint"><a href="bhadadiyeko_print_taken.php?enlist_id=<?= $_GET['enlist_id'] ?>&khata_number=<?= $_GET['khata_number'] ?>" target="_blank">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>
                            ...
                            <tr>
                                <td colspan="3" class="mycenter"><legend> <b>भाडामा दिने व्यक्त्ती वा कार्यालयको:</b> </legend></td>
                            </tr>
                             <tr>
                                  ...
                                  <table class="table myWidth100 table-bordered table-responsive">
                                      <tr>
                                <td colspan="15" class="mycenter"><legend> <b>भाडामा लिएको सामानको विवरण:</b> </legend></td>
                                 </tr>
                                 <tr>
                                     ...
                                     <th class="myWidth5"  rowspan="2">हटाउनु होस्</th>
                                 </tr>
                                  <tr >
                                                ...
                                                <th class="myWidth5">सामानको  नाम </th>
                                                 ...
                                                 <th class="myWidth5"> भाडामा लिईएको सामानको परिमाण</th>
                                 ...
                                 <?php $i=1; foreach ($bhada as $data1):
                                     $bhada_details = Bhadadetailstaken::find_by_bhada_id($data1->id);
                                     foreach($bhada_details as $data):
                                           $sql_return    = "select * from bhada_return_history_taken where item_id ={$data->item_id} and category={$data->category} and rate={$data->item_rate} and bhada_id={$data1->id}";
                                     ...
                                     ?>         
                                                ...
                                                <input type="hidden" value="2" id="category-1">
                                                   ...
                                                   <td ><?= convertedcit($data->item_rate) ?></td>
                                                  <td >
                                                      <?= $period_type ?>
                                                    </td>
                                                  ...
                                                  <td class="myWidth5">  <?php if(empty($return_result))
                                                      {?> 
                                                      <a class="btn " href="bhada_edit_dashboard_taken.php?id=<?= $data->id ?>&id_return=1">हटाउनुहोस्</a>
                                                <?php  }
                                                      else
                                                      { ?>
                                                       <a class="btn" href="bhada_edit_dashboard_taken.php?id=<?= $data->id ?>&id_return=2">हटाउनुहोस्</a>
                                                <?php } ?></td>
                                                </tr>
                             <?php $i++; endforeach;
                             endforeach;
