<?php 
   ...
   //print_r($alldates);exit;
    if(empty($alldates[0]))
    {
     echo alertBox("यस किसिमको रशिदको कुनै पनि आम्दानी / वितरण भएको छैन |","bill_control_view_type.php");
     exit;
    }
...
<body>
    ...
    <div id="body_wrap_inner"> 
                ...
                <div class="maincontents">
                    <!--<h2 class="headinguserprofile">रसिद नियन्त्रण खाता| </h2>-->
                    <div class="OurContentFull">
                        <h2><a href="bill_control_add.php" class="btn">रसिद नियन्त्रण खाता थप्नुहोस </a>|| <a href="bill_control_dashboard.php" class="btn">पछि जानुहोस </a> </h2>
                        <div class="myPrint"><a href="bill_control_view_print.php?id=<?= $description_id ?>" target="_blank">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>
