...
$date_selected = $_GET['date_selected1'];
//print_r($date_selected);
    	...
    	<div class="userprofiletable">
               <?php // foreach($prastabana_result as $prastabana){
				...
				<div class="printContent">
                                        <div class="mydate"><b> मिति :- </b><?php echo convertedcit($date_selected);?></div>
					...
					<div class="chalanino"><b> चलानी नम्बर :-</b> </div>					
                                        ...
                                        <div class="bankdetails">
                                        	उपरोक्त बिषयमा तपाइको फर्म यस कार्यालयमा सुचिकृत भएकाले नगरपालिकाको लागी तपशिल बमोजिमका सामानहरु आबश्यक भएकाले के कति दररेटमा उपलब्ध गराउन सकिन्छ र समान सप्लाइ गर्न इच्छुक भएमा <?= convertedcit($prastabana->prastabana_entry_date) ?> दिन भित्रमा यस पत्रमा उल्लेखित समानहरुको दररेट उपलब्ध गराइदिनु हुन् अनुरोध छ  ।
                                            <div class="myspacer"></div>
                                        </div>
									  <div class="bankdetails">
									      <br>
                          ...
                          <div class="oursignatureleft" style="margin-left:550px"><br>
                          प्रमुख प्रशासकीय अधिकृत</div>
