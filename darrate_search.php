...
if(isset($_GET['submit']) || isset($_GET['kharid_id']))
{
    ...
    {
        echo alertBox("निम्न खरिद फारम नं को प्रस्तावना फारम भरिएको छैन ....","darrate_search.php");
    }
}
...
<!-- js ends -->
<title>कोटेशन पेश गर्ने सम्बन्धमा।</title>
...
<body>
    ...
    <div id="body_wrap_inner"> 
                ...
                <div class="maincontent">
                    <h2 class="headinguserprofile"> <u>दर रेट उपलब्ध गराउने बारे । </u>  <a href="darrate_search.php" class="btn">पछि जानुहोस </a></h2>
                    <div class="OurContentFull">
                    	<h2>दर रेट उपलब्ध  गर्ने सम्बन्धमा।</h2>
                        <div class="userprofiletable">
                            <form method="get">
                        	<table class="table table-responsive bordereless search_table">
                                          <tr>
                                              <td>दर रेट खोज्नुहोस : <input class="fill_height" type="text" name="kharid_id" placeholder="खरिद नं हल्नुहोस "/> <input type="submit" name="submit" value="खोज्नुहोस" class="btn search_btn"/></td>
                                          </tr>
                                </table>
                            </form>
                            <?php if(!isset($_GET['submit']) && !isset($_GET['kharid_id'])):?>
                             <table  class="table table-bordered table-responsive td1">
                                <tr>
                                    <th>सि नं</th>
                                    <th>खरिद फारम नं </th>
                                     <th>कोटेसनको प्रकार </th>
                                      <th> कोटेसन माग गरेको मिती</th>
                                   <th>फर्म/कम्पनी</th>
                                    <th>हेर्नुहोस</th>
                                </tr>
                                ...
                                <tr>
                                   <td><?=convertedcit($i)?></td> 
                                    ...
                                    <td><a href="darrate_print.php?kharid_id=<?=$data->kharid_id?>" class="btn">पुरा विवरण हेर्नुहोस</a>  <?php if(empty($tippani_result)){ ?><a href="prastabana_delete.php?kharid_id=<?=$data->kharid_id?>" class="btn">हटाउनुहोस</a><?php } ?></td>
                            ...
                            ?>
                            <div class="myPrint"><a href="darrate_print.php?kharid_id=<?php echo $_GET['kharid_id'];?>" target="_blank">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>
                            <?php
									...
									<div class="printContent">
                                        ...
                                        <div class="subjectBold letter_subject">बिषय – दर रेट उपलब्ध गराउने बारे  </div>
                                        <div class="chalanino">
