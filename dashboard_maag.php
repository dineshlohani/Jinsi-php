    	...
    	<div class="">
            <div class="">
                <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 maincontent">
                    <h2 class="dashboard">माग फारम | <a href="index.php" class="btn">पछि जानुहोस्  </a></h2>
                    <div class="dashboardcontent">
                    	<a href="dashboard_maag1.php"><div class="userprofile">
                        	<h3>खरिद माग फारम</h3>
                            <div class="dashimg">
                            	<img src="images/new_plan_icon.png" alt="New Plan  Icons" class="dashimg" />
                            </div>
                        </div></a><!-- user profile ends -->
				<a href="dashboard_kharcha.php"><div class="userprofile">
                        	<h3>खर्च माग फारम</h3>
                            <div class="dashimg">
