...
//    echo "<pre>"; print_r($_POST); echo "</pre>"; exit;
    $profile = EvaluationProfile::find_by_id($_POST['profile_id']);
    $profile->date_nepali = $_POST['date_nepali'];
    $profile->date_english = DateNepToEng($_POST['date_nepali']);
    $profile_id = $profile->save();
    $edit_details = EvaluationDetails::find_by_profile_id($_POST['profile_id']);
    ...
    $edit_details = MemberInvited::find_by_profile_id_type_id($_POST['profile_id'],2);
    foreach($edit_details as $edit_detail)
    {
        $edit_detail->delete();
    }
...
//        $details->sno_taken = $i+1;
   ...
   echo alertBox("कार्य सफल", "evaluation_view.php");
}
$profile_selected = EvaluationProfile::find_by_id((int) $_GET['id']);
$details_selected = EvaluationDetails::find_by_profile_id((int) $_GET['id']);
$members_selected = MemberInvited::find_by_profile_id_type_id($profile_selected->id,2);
?>
...
<body>
    ...
    <div id="body_wrap_inner"> 
    	<div class="maincontent">
             <h2 class="headinguserprofile">प्रस्ताव |  <a href="evaluation_view.php" class="btn">पछि जानुहोस</a></h2>
