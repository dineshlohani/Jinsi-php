...
$profile = EvaluationProfile::find_by_id((int) $_GET['id']);
$profile_details = EvaluationDetails::find_by_profile_id($profile->id);
$member_details  = MemberInvited::find_by_profile_id_type_id($profile->id,2); 
$kharid_ikai_profile = EvaluationSamitiProfile::find_current();
$kharid_ikai_details = EvaluationSamitiDetails::find_by_profile_id($kharid_ikai_profile->id);
$sanyojak = getSanojakEvaluation($kharid_ikai_profile->id,1);
//echo $sanyojak; exit;
    ...
    <div class="myPrintFinals" > 
    	<div class="userprofiletable">
               <div class="printPage">
                                                                            ...
                                                                            <div class="subjectBold letter_subject">मुल्यांकन समिति बैठक खाता</div>
                                                                            <div class="printContent">
                                                                                    ...
                                                                                    <div class="banktextdetailss">
                                                                                        <p>
                                                                                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  आज मिति <?=convertedcit($profile->date_nepali)?> गते यस <?=SITE_NAME?> मुल्यांकन समिति संयोजक श्री <?=$sanyojak?> को अधक्ष्यतामा मा बसेको बैठक मा देहाय बमोजिमको उपस्थिथि रह्यो | 
                                                                                           <br/>तपसिल :
                                                                                        </p>
                                                                                        <div class="myspacer"></div>
