...
class Aanyareason
{
	protected static $table_name = "aanya_reason";
	protected static $db_fields = array('id','aanya_prastabana_id','aanya_prastabana_reason');
	public $id;
	public $aanya_prastabana_id;
        public $aanya_prastabana_reason;
       
        // Common database method
        public static function find_by_aanya_prastabana_id($kharid_id=0)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where aanya_prastabana_id={$kharid_id} ");
		return $result_array;
	}
