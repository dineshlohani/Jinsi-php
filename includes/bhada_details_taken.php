...
class Bhadadetailstaken
{
	protected static $table_name = "bhada_details_taken";
	protected static $db_fields = array('id','bhada_id','item_id','category','item_rate','period_type','period_rate','period','qty','bhada_amount','start_date','end_date','return_qty','return_date','item_condition_id');
	public $id;
	public $bhada_id ;
        public $item_id;
        public $category;
	...
	public static function find_all()
	{
        ...
        public static function find_by_bhada_id($id)
	{
		global $database;
		return self::find_by_sql("select * from ".self::$table_name." where bhada_id={$id}");
        ...
        public function getName($string_id="")
            ...
            public function getpost($string_id="")
            {
                     ...
                     $topic_selected = self::find_by_id($string_id);
                     return $topic_names = $topic_selected->post;   
            }
