...
class Bhadaliyekodetails
{
	protected static $table_name = "bhada_liyeko_details";
	protected static $db_fields = array('id','property_id','rent_item_name','miti','miti_english','approved_date',
       'approved_date_english','start_date','start_date_english','org_name','org_address','item_count'
        ,'end_date','end_date_english','rent_unit_id','rent_period','rent_period_english','per_unit_rent',
        'total_rent_amount','item_return_order_date','item_return_order_date_english','return_date','return_date_english');
        public $id;
        public $rent_item_name;
        public $miti;
        public $miti_english;
        ...
        public $item_count;
        public $rent_period;
        public $rent_period_english;
        public $per_unit_rent;
        public $total_rent_amount;
        public $item_return_order_date;
        public $item_return_order_date_english;
        public $return_date;
