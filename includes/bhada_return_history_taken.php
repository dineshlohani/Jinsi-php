...
class Bhadareturnhistorytaken
{
	protected static $table_name = "bhada_return_history_taken";
	protected static $db_fields = array('id','enlist_id','item_id','rate','category','type','return_date','qty','bhada_id','item_condition_id');
	public $id;
        public $enlist_id;
        public $item_id;
        public $rate;
