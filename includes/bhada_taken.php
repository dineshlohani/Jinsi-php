...
class Bhadataken
{
	protected static $table_name = "bhada_taken";
	protected static $db_fields = array('id','khata_number','taken_date','fiscal_id','enlist_id','type','return_date','dakhila_date');
	public $id;
	public $khata_number ;
        public $taken_date;
        public $fiscal_id;
	...
	public static function find_all()
	{
		...
		return self::find_by_sql("select * from ".self::$table_name);
           ...
           public static function get_new_khata_id($enlist_id)
       {
        global $database;   
        $sql_max    = "select max(khata_number) as max  from ".self::$table_name;
        ...
        $sql="select khata_number  from ".self::$table_name." where enlist_id={$enlist_id}";
        $result= $database->query($sql);
        $row= $database->fetch_assoc($result);
        if(empty($row['khata_number']))
                {
                    return $max;
                }
                else
                {
                    return $row['khata_number'];
                }
