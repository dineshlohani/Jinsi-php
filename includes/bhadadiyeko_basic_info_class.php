...
class Bhadadiyekobasicinfo
{
	protected static $table_name = "bhada_diyeko_basic_info";
	protected static $db_fields = array('id','property_id','fiscal_id','property_name','property_model_no',
        'property_category_id','jinsi_id','created_date','created_date_english');
        public $id;
        public $property_id;
        public $fiscal_id;
        public $property_name;
        public $property_model_no;
