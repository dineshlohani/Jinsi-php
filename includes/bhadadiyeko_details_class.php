...
class Bhadadiyekodetails
{
	protected static $table_name = "bhada_diyeko_details";
	protected static $db_fields = array('id','property_id','customer_name','customer_address','count','approved_date',
       'approved_date_english','start_date','start_date_english','end_date','end_date_english','rent_unit_id'
        ,'period','period_english','period_per_unit_price','total_rent','rent_end_time','rent_end_time_english',
        'per_unit_price','total_rent_amount','rashid_no','return_date','return_date_english','dakhila_date','dakhila_date_english');
        public $id;
        ...
        public $end_date;
        public $end_date_english;
        public $rent_unit_id;
        public $period;
        public $period_english;
        public $period_per_unit_price;
        public $total_rent;
        public $rent_end_time;
        public $rent_end_time_english;
        public $per_unit_price;
        public $total_rent_amount;
        public $rashid_no;
        public $return_date;
        public $return_date_english;
        public $dakhila_date;
        public $dakhila_date_english;
         public $property_id;
        ...
        public static function find_by_property_id($id)
        {
            $sql = "select * from ".self::$table_name. " where property_id=$id";
