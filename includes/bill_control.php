...
class BillControl
{
	protected static $table_name = "bill_control";
	protected static $db_fields = array('id','nepali_date','english_date','quantity','description_id','pressed_from','pressed_to','pressed_total','passed_from','passed_to','passed_total','maujdata_from','maujdata_to','maujdata_total','verified_by');
	public $id;
	public $nepali_date;
        public $english_date;
        public $quantity;
        ...
        public $passed_to;
        public $passed_total;
        public $maujdata_from;
        public $maujdata_to;
        public $maujdata_total;
        public $verified_by;
