...
require_once('database.php');
    ...
    class BillDispatchDetails
{
	protected static $table_name = "bill_dispatch_details";
	protected static $db_fields = array('id','dispatched_rashid','pressed_from','pressed_to',
                'total','dispatch_id');
	public $id;
        public $dispatched_rashid;
        public $pressed_from;
        public $pressed_to;
        public $total;
        public $dispatch_id;
...
// Common database method
	public static function find_all()
	{
        ...
        public static function find_by_dispatch_id($dispatch_id)
	{
		global $database;
		return self::find_by_sql("select * from ".self::$table_name." where dispatch_id={$dispatch_id} ");
