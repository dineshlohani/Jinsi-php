...
class EvaluationSamitiDetails 
{
	protected static $table_name = "evaluation_samiti_details";
	protected static $db_fields = array('id','worker_id','pad_id','profile_id');
	public $id;
	public $worker_id;
        public $pad_id;
        public $profile_id;
        ...
        public static function find_by_profile_id($profile_id=0)
	{
        ...
        {
            $result_array=self::find_by_sql("select * from ".self::$table_name. " where profile_id={$profile_id} and pad_id={$sanyojak_id} limit 1");
            return !empty($result_array)? array_shift($result_array) : false;
        }
