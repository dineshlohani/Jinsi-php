...
class EvaluationSamitiProfile 
{
	protected static $table_name = "evaluation_samiti_profile";
	protected static $db_fields = array('id','date_nepali','date_english','sno','is_current');
	public $id;
	public $date_nepali;
        public $date_english;
        public $sno;
        ...
        public static function find_current()
	{
        ...
        public static function set_current($id=0)
        {
            global $database;
            $sql = "update ".self::$table_name." set is_current=0 where id!={$id}";
            $database->query($sql);
            $sql = "update ".self::$table_name." set is_current=1 where id={$id}";
            $database->query($sql);
        }
