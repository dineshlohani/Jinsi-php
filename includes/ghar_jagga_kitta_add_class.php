...
class Gharjaggakittaadd
{
	protected static $table_name = "gharjagga_kitta_add";
	protected static $db_fields = array('id','ghar_jagga_id','land_kitta_id','land_total_area',
            'land_unit_id');
        public $id;
        public $ghar_jagga_id;
        public $land_kitta_id;
        public $land_total_area;
        public $land_unit_id;
        ...
        public static function find_by_ghar_jagga_id($id)
        {
            $sql = "select * from ".self::$table_name. " where ghar_jagga_id=$id";
