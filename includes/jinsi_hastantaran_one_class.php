...
class Hastantaranone
{
	protected static $table_name = "hastantaran_one";
	protected static $db_fields = array('id','hastantaran_id','hastantaran_date','hastantaran_date_english','office_id','worker_id');
	public $id;
        public $hastantaran_id;
        public $hastantaran_date;
        public $hastantaran_date_english;
        public $office_id;
        public $worker_id;
