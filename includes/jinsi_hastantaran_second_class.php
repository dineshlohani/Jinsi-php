...
class Hastantaransecond
{
	protected static $table_name = "hastantaran_second";
	protected static $db_fields = array('id','hastantaran_id','rate','item_id','category','quantity','total_amount','created_date','created_date_english','current_status','prev_stock');
	public $id;
        ...
        // Common database method
         public static function find_by_hastantaran_id($id)
        {
            $sql = "select * from ".self::$table_name. " where hastantaran_id={$id}";
