...
class Jinsililamapprove
{
	protected static $table_name = "jinsi_lilam_approve";
	protected static $db_fields = array('id','jinsi_lilam_id','item_id','category','stock_entry_date','stock_id','prev_stock','rate','reduce_stock','current_analysed_rate','reason','created_date','created_date_english');
	public $id;
