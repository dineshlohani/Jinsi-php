...
class Jinsililamfinal
{
	protected static $table_name = "jinsi_lilam_final";
	protected static $db_fields = array('id','jinsi_lilam_id','item_id','category','stock_entry_date','stock_id','prev_stock','rate','reduce_stock','current_analysed_rate','reason','created_date','created_date_english','actual_reduced_stock');
	public $id;
        public $jinsi_lilam_id;
        public $prev_stock;
        public $item_id;
        public $category;
        public $rate;
	...
	public $current_analysed_rate;
        ...
        // Common database method
         public static function find_by_jinsi_lilam_id($id)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where jinsi_lilam_id={$id} ");
		return $result_array;
	}
        public static function find_by_jinsi_lilam_ids($id)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where jinsi_lilam_id={$id} limit 1 ");
