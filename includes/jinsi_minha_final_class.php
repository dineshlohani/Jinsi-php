...
class Jinsiminhafinal
{
	protected static $table_name = "jinsi_minha_final";
	protected static $db_fields = array('id','jinsi_minha_id','item_id','category','rate','prev_stock','stock_entry_date','stock_id','reduce_stock','current_analysed_rate','reason','created_date','created_date_english','actual_reduced_stock');
	public $id;
        public $jinsi_minha_id;
        public $item_id;
        public $category;
        public $prev_stock;
        public $stock_entry_date;
	public $stock_id;
        public $rate;
        public $reduce_stock;
	public $current_analysed_rate;
        public $reason;
        public $created_date;
        public $created_date_englsih;
        public $actual_reduced_stock;
        
        // Common database method
        public static function find_by_jinsi_minha_id($id)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where jinsi_minha_id={$id} ");
		return $result_array;
	}
         public static function find_by_jinsi_minha_ids($id)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where jinsi_minha_id={$id} limit 1");
		return !empty($result_array)? array_shift($result_array) : false;
	}
         public static function get_max_jinsi_minha_id()
        {
            global $database;
            $sql = "select max(jinsi_minha_id) from ".self::$table_name. " ";
