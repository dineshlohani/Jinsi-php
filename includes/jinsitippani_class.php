...
class Jinsitippani
{
	protected static $table_name = "jinsi_tippani";
	protected static $db_fields = array('id','org_id','status','category','kharid_id','item_id','rate_tippani','total_rate','tippani_miti','tippani_miti_english');
	public $id;
        public $org_id;
        public $item_id;
        public $rate_tippani;
