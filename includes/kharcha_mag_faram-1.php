...
class Kharcha_mag_faram1
{
	protected static $table_name = "kharcha_mag_faram_1";
	protected static $db_fields = array('id','fiscal_id','department_id','maag_date','maag_date_english');
	public $id;
	public $fiscal_id;
