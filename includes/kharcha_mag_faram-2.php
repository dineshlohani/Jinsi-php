...
class Kharcha_mag_faram2
{
	protected static $table_name = "kharcha_mag_faram_2";
	protected static $db_fields = array('id','item_id','category','prev_stock','rate','qty','maag_id');
	public $id;
        public $item_id;
	public $category;
	public $prev_stock;
