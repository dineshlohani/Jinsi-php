...
class KharidAdeshItemDetails
{
	protected static $table_name = "kharid_adesh_item_details";
	protected static $db_fields = array('id','item_id','category','rate','qty','total','vat_amount','vat_total','remarks','vat_status','adesh_id');
	public $id;
	public $item_id;
    public $category;
	public $rate;
