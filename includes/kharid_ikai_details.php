...
class KharidIkaiDetails 
{
	protected static $table_name = "kharid_ikai_details";
	...
	public static function find_by_id($id=0)
	{
        ...
        {
            $sql = "select * from ".self::$table_name. " where profile_id={$profile_id} and pad_id={$sanyojak_id} limit 1";
