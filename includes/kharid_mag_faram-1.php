...
class Kharid_mag_faram1
{
	protected static $table_name = "kharid_mag_faram_1";
	protected static $db_fields = array('id','fiscal_id','department_id','maag_date','maag_date_english','status','kharid_maag_process');
	public $id;
	public $fiscal_id;
    public $department_id;
	public $maag_date;
	public $maag_date_english;
	public $status;
	public $kharid_maag_process;
