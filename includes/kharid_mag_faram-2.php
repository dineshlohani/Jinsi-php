...
require_once('database.php');
    ...
    class Kharid_mag_faram2
{
	protected static $table_name = "kharid_mag_faram_2";
	protected static $db_fields = array('id','item_id','category','prev_stock','qty','maag_id','remarks');
	public $id;
    public $item_id;
	public $category;
	public $prev_stock;
	...
	public $remarks;
        ...
        public static function find_by_maag_id_item_id_category($maag_id=0,$item_id=0,$category=0)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where maag_id={$maag_id} and item_id={$item_id} and category=$category limit 1");
	...
	public static function find_by_maag_id($maag_id=0)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where maag_id={$maag_id} ");
		return $result_array;
	}
