...
class Kharid_mag_faram
{
	protected static $table_name = "kharid_mag_faram";
	protected static $db_fields = array('id',' department_id ','date','date_english','name_id ','amount',' buy_amount ');
	public $id;
        public $buy_amount ;
