...
{
	protected static $table_name = "land_description";
	protected static $db_fields = array('id','sn','land_owner_id','land_id','old_vdc_mp_id','old_ward_id','new_vdc_mp_id','new_ward_id','road_id','nn','kn','area1','area2','area3','area4','unit_id','minimum_amount','land_taken_date');
	public $id;
        public $sn;
        public $land_owner_id;
        public $land_id;
	public $old_vdc_mp_id;
	public $old_ward_id;
	public $new_vdc_mp_id;
	public $new_ward_id;
	public $road_id;
	public $nn;
	public $kn;
