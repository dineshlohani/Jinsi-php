...
class Ledgerdetails
{
	protected static $table_name = "ledger_details";
	protected static $db_fields = array('id','ledger_id','item_id','category','rate','qty','return_qty','given_condition_id');
	public $id;
        public $ledger_id;
        public $item_id;
        public $category;
