...
class Ledgerreturnhistory
{
	protected static $table_name = "ledger_return_history";
	protected static $db_fields = array('id','enlist_id','item_id','rate','category','type','return_date','qty','ledger_id','item_condition_id');
	public $id;
        public $enlist_id;
        public $item_id;
        public $rate;
        ...
        public $qty;
        public $ledger_id;
        public $item_condition_id;
       
  
        
        
        // Common database method
        public static function sum_qty_by_item_id_rate_category($item_id,$rate,$category)
	{
		global $database;
		$sql = "select sum(qty) from ".self::$table_name." where item_id={$item_id} and rate={$rate} and category={$category}";
      ...
      public static function get_item_details($ledger_id)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where ledger_id={$ledger_id}");
		return $result_array;
	}
