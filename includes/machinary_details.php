...
class Machinarydetails
{
	protected static $table_name = "machinary_details";
	protected static $db_fields = array('id','item_type_id','category','machinary_id','miti','miti_english'
            ,'item_id','item_amount','item_rate','total_amount','grand_total','vat_amount','sum_amount');
	public $id;
	public $item_type_id;
        public $machinary_id;
        public $miti;
