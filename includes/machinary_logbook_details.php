...
class Machinarylogdetails
{
	protected static $table_name = "machinary_log_details";
	protected static $db_fields = array('id','log_id','log_miti','log_miti_english'
                ,'place_to','place_from','km_to','km_from','total','petrol','mobil','grease','oil');
	public $id;
	public $log_id;
        public $log_miti;
        public $log_miti_english;
        public $place_to;
        public $place_from;
        public $km_to;
        public $km_from;
