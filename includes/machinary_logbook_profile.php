...
class Machinarylogprofile
{
	protected static $table_name = "machinary_log_profile";
	protected static $db_fields = array('id','type','enlist_id','machine_no','machine_type','miti','miti_english');
	public $id;
	public $type;
	public $enlist_id;
	public $machine_no;
        ...
        public static function find_by_enlist_id($id=0)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where enlist_id={$id} limit 1");
	...
	public static function find_all()
	{
		...
		return self::find_by_sql("select * from ".self::$table_name);
         ...
         public static function find_by_item_type_id($id=0)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where item_type_id={$id}");
		return $result_array;
	}
