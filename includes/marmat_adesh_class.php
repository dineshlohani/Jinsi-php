...
class Marmatadesh
{
	protected static $table_name = "marmat_adesh";
        protected static $db_fields = array('id','adesh_no','item_id','item_type_id','category','counter','quantity',
            'marmat_details','amount','remarks');
        public $id;
        public $adesh_no;
        public $item_id;
        public $item_type_id;
        ...
        public $unit_id;
        public $quantity;  
        public $marmat_details;
        public $amount;
        public $final_amount;
        public $remarks;
        // Common database method
         public static function get_max_adesh_no()
        {
            global $database;
            $sql = "select max(adesh_no) from ".self::$table_name. " ";
...
public function resetAutoIncrement()
	...
	{
		global $database;
		$result_array = self::find_by_sql("select * from ".self::$table_name. " where adesh_no={$adesh_id} ");
		return $result_array;
	}
