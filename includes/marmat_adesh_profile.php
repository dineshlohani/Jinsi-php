...
class Marmatadeshprofile
{
	protected static $table_name = "marmat_adesh_profile";
        protected static $db_fields = array('id','adesh_no','type','enlist_id','order_date','order_date_english');
        public $id;
        public $adesh_no;
        public $type;
        public $enlist_id;
        public $order_date;  
        public $order_date_english;
