...
class Orderform
{
	protected static $table_name = "order_form";
	protected static $db_fields = array('id','sn','branch_id','date','date_english','fiscal_id','item_type_id','item_id','pan_no','quantity','unit_id','buy_quantity');
	public $id;
	public $sn ;
        public $branch_id ;
        public $date ;
