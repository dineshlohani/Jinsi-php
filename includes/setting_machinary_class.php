...
class Machinary
{
	protected static $table_name = "machinary";
	protected static $db_fields = array('id','name','type','model','engine_no','made_in','chesis_no','darta_no'
         ,'weight','jinsi_id','detail','price','miti','miti_english');
	public $id;
	public $name;
        public $type;
        public $model;
