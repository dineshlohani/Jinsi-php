...
class Notspentitem
{
	protected static $table_name = "settings_not_spent_item";
	protected static $db_fields = array('id','name','brand','specification','made_in','size','time_period','budget_title_id','unit_id','item_type_id');
	public $id;
	public $name;
        public $brand;
