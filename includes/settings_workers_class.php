...
class Workers
{
	...
	protected static $db_fields = array('id','shreni_id','taha_id','type','name','post','is_jinsi');
	public $id;
	public $name ;
        public $shreni_id;
        public $taha_id;
    ...
    public static function getJinsiWorkers()
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where is_jinsi=1 ");
		return $result_array;
	}
