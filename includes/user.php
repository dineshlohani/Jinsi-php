...
class User extends DatabaseObject
{
	...
	protected static $db_fields = array('id','name','ward','phone','email','status','username','appointed_date','appointed_date_english','mode','password');
	public $id;
	public $username;
	public $password;
	public $name;
        ...
        public function getName($string_id="")
            {
                     ...
                     return $topic_names = $topic_selected->username;   
            }
