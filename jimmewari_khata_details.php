                ...
                <div class="maincontent">
                    ...
                    <div class="OurContentFull">
                        ...
                        <div class="userprofiletable">
                            ...
                            <div class="myPrint"><a href="jimmewari_khata_details_prints.php?item_id=<?=$_GET['item_id']?>& category=<?=$_GET['category']?>& rate=<?=$_GET['rate']?>" target="_blank">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>
                                          <div class="printPage">
