...
{
	$jinsi_minha_result=  Jinsiminha::find_by_jinsi_minha_id($_GET['jinsi_minha_id']);
...
//     echo "<pre>";print_r($_POST);echo "</pre>";exit;
    ...
    echo alertBox("थप सफल ", "jinsi_minha_approve.php");
}
$item_type = Itemtype::find_all();

$lilam_result = Jinsiminha::find_by_sql("select distinct jinsi_minha_id from jinsi_minha");
?>
                          ...
                          <?php if(!isset($_GET['submit']) && !isset($_GET['jinsi_minha_id'])):?>
                            <table class="table table-responsive bordereless search_table">
                                ...
                                <?php foreach($lilam_result as $data):
                                    $result= Jinsiminha::find_by_jinsi_minha_ids($data->jinsi_minha_id);?>
                                <tr>
                                    <td><?=convertedcit($data->jinsi_minha_id);?></td>
                                    <td><?=convertedcit($result->created_date);?></td>
                                    <td><a href="jinsi_minha_approve.php?jinsi_minha_id=<?=$data->jinsi_minha_id?>" class="btn">खोज्नुहोस</a></td>
                                </tr>
                                <?php endforeach;?>
                            </table>
                            <?php endif;?>
...
//                                        echo $total_year;exit;
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="reduce_stock[]" id="reduce_lilam_stock_<?=$i?>"></td>
