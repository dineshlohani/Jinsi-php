...
<!-- js ends -->
<title>जिन्सी मिन्हा फाराम</title>
...
<body>
    ...
    <div id="body_wrap_inner"> 
                ...
                <div class="maincontent">
                    <h2 class="headinguserprofile">जिन्सी मिन्हा फाराम| <a href="jinsi_minha_dashboard.php" class="btn">पछि जानुहोस </a></h2>
                    <div class="OurContentFull">
                    	<h2>जिन्सी मिन्हा फाराम</h2>
                        <div class="userprofiletable">
                        	       <form method="get">
                        	<table class="table table-responsive bordereless search_table">
                                          <tr>
                                              <td>जिन्सी मिन्हा फाराम	खोज्नुहोस:  <input class="fill_height" type="text" name="jinsi_lilam_id"/> <input type="submit" name="submit" value="खोज्नुहोस" class="btn search_btn"/></td>
                                          </tr>
                                </table>
                            </form>
                            ...
                            <table class="table table-responsive bordereless search_table">
                                ...
                                <tr>
                                    ...
                                    <td><a href="jinsi_minha_tippani.php?jinsi_minha_id=<?=$data->jinsi_minha_id?>" class="btn">खोज्नुहोस</a></td>
                                </tr>
                                <?php endforeach;?>
                            </table>
                            <?php endif;?>
                            <?php if(isset($_GET['submit']) || isset($_GET['jinsi_minha_id'])):
                                $jinsi_lilam_date = Jinsiminhafinal::find_by_jinsi_minha_ids($_GET['jinsi_minha_id']);?>
                            <div class="myPrint"><a href="jinsi_minha_tippani_print.php?jinsi_minha_id=<?=$jinsi_minha_id?>" target="_blank">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>
                                          <div class="printPage">
