<?php require_once("includes/initialize.php"); 
    $khata_id = '';
    $array_result= ItemStock::find_by_sql("select distinct item_id from item_stock where category=2 order by khata_id ASC");
    if(isset($_GET['khata_id']))
    {
        $khata_id = $_GET['khata_id'];
        $khata_result = ItemStock::find_by_khata_id($khata_id,2);
        //print_r($khata_result);exit;
        //$khata = ItemStock::find_by_sql("select * from item_stock where khata_id = $khata_id and category=2");
        // foreach($khata as $khata):
        //     endforeach;
        // echo"<pre>";
        //     print_r($khata);
...
<!-- js ends -->
<title>खप्ने जिन्सी सामानको खाता खोज्नुहोस:: <?= getSiteTitle()?></title>
<body>
    	...
    	<div class="">
            <div class="">
                <div class="maincontent">
                    <h2 class="headinguserprofile">खप्ने जिन्सी सामानको खाता खोज्नुहोस / <a class="btn" href="dashboard_jinsikhata.php">जिन्सी खातामा जानुहोस </a> </h2>
                    
                    <div class="OurContentFull">
                    	<h2>खप्ने जिन्सी सामानको खाता खोज्नुहोस	 </h2>
                        <div class="userprofiletable">
                            <form method="get">
                        	<table class="table table-responsive borderless search_table">
                                          <tr>
                                              <td>खप्ने जिन्सी सामानको खाता खोज्नुहोस: <input class="fill_height" type="text" name="khata_id" value="<?=$khata_id?>" /> <input type="submit" value="खोज्नुहोस" class="btn search_btn"/></td>
                                          </tr>
                                </table>
                            </form>
                             <?php if(isset($_GET['khata_id'])){  ?>
                            <?php if(empty($item_selected)) {echo '<p class="mycenter"><b>सम्बन्धित खाता भेटिएन पुन: प्रयास गर्नुहोस</b></p><br>'; exit;}?>
                            <div class="myPrint"><a href="jinsikhapne_search_print.php?khata_id=<?=$_GET['khata_id']?>" target="_blank">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>
                                    <div class="printPage">
                      ...
                      // echo $maag_sql; exit;
                        ...
                        $hastantaran_rows = $database->num_rows($hastantaran_result);
                         ...
                         $jinsiminha_sql="select * from jinsi_minha_final where item_id=$item_id and category=2 and created_date_english='".$date_selected."'";
//                        echo $jinsiminha_sql;
                         $jinsiminha_result = $database->query($jinsiminha_sql);
                        $jinsiminha_rows = $database->num_rows($jinsiminha_result);
                        
                         $jinsililam_sql="select * from jinsi_lilam_final where item_id=$item_id and category=2 and created_date_english='".$date_selected."'";
                        ...
                        ?>
                                      ...
                                      ?>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td>गत मौज्दात</td>
                                                    <td><?=convertedcit((float)$dakhila_fetch->prev_stock)?></td>
                            ...
                            <table  class="table table-bordered td1 table-responsive">
                                ...
                                <tr>
                                   <td><?=convertedcit($stock->khata_id)?></td> 
                                    ...
                                    <td><a href="jinsikhapne_search.php?khata_id=<?=$stock->khata_id?>" class="btn">पुरा विवरण हेर्नुहोस</a></td>
                                </tr>
                                <?php endforeach; ?>
                            </table>
