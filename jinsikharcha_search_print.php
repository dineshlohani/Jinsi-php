...
<!-- js ends -->
<title>खर्च भएर जाने जिन्सी मालसामानको खाता खोज्नुहोस:: <?php echo SITE_SUBHEADING;?></title>

<body>
    <div class="myPrintFinal" > 
    	<div class="userprofiletable">
               <div class="printPage">
                    <div class="mydate"><b>म.ले.प. फाराम नं :- </b>५२</div><br>
                             ...
                             while($dakhila_fetch = mysqli_fetch_object($stock_result)):
                                      ...
                                      ?>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td></td>
                                                     <td>गत मौज्दात</td>
                                                    <td><?=convertedcit($dakhila_fetch->prev_stock)?></td>
                           ...
                           <?php if($maag_rows>0):
                               ...
                               ?>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td></td>
                                                    <td>&nbsp;</td>
                                                    <td><?=convertedcit($maag_fetch->qty+0)?></td>
                               ...
                               ?>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td></td>
                                                    <td>&nbsp;</td>
                                                    <td><?=convertedcit($has_fetch->quantity+0)?></td>
                               ...
                               ?>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td></td>
                                                    <td>&nbsp;</td>
                                                    <td><?=convertedcit($minha_fetch->actual_reduced_stock+0)?></td>
                               ...
                               ?>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td></td>
                                                    <td>&nbsp;</td>
                                                    <td><?=convertedcit($lilam_fetch->reduce_stock+0)?></td>
