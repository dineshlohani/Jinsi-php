...
if(isset($_GET['submit']) || isset($_GET['nirikshan_id']))
{
    ...
    if(empty($_GET['nirikshan_id']) && !is_numeric($_GET['nirikshan_id']))
    {
        echo alertBox("कृपया अंक हालेर खोज्नुहोला", "jinsinirakshan_kharchaformfill.php");
    }
    else
    {
        $nirikshan_id=$_GET['nirikshan_id'];
        $result= Notspentjinsinirakshan::find_by_nirikshan_id($_GET['nirikshan_id']);
    }
        if(empty($result))
        {
...
{
    $result = Notspentjinsinirakshan::find_by_sql("select distinct nirikshan_id from notspent_jinsinirakshan");
    	...
    	<div class="">
            <div class="">
                <div class="maincontent">
                    <h2 class="headinguserprofile">खर्च भएर नजाने जिन्सी मालसामानको निरिक्षण फाराम भर्नुहोस / <a href="dashboard_jinsinirakshankharchanot.php" class="btn">पछी जानुहोस </a> </h2>
                    ...
                    <div class="OurContentFull">
                        ...
                        <form method="get">
                             <table  class="table table-responsive bordereless search_table">
                                <tr>
                                 <td colspan="5">निरिक्षण फाराम नं : <input type="text"  name="nirikshan_id" /> <input type="submit" value="खोज्नुहोस" name="submit" class="btn search_btn"/></td>
                                                      
                                </tr>
                            </table>
                        </form>
                        <?php if(isset($_GET['nirikshan_id'])){
                            $nirikshan_date_result = Notspentjinsinirakshan::find_by_nirikshan_ids($_GET['nirikshan_id']);?>
                        <div class="userprofiletable">
                        	
                            <div class="myPrint"><a href="jinsinirakshan_kharchaformfillnot_print.php?nirikshan_id=<?php echo $nirikshan_id;?>" target="_blank">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>
                                          <div class="printPage">
									...
									<div class="printContent">
										...
										<div class="bankdetails">
										     ...
										     <table  class="table table-bordered table-responsive">
                                                    <tr>
                                                                                             <td colspan="5"><b>निरिक्षण फाराम नं :</b></td>
                                                                                             <td colspan="10"><b><?php echo convertedcit($nirikshan_id);?></b></td>
                                                                                         </tr>
                                                                                         <tr>
                                                                                             <td colspan="5"><b>निरिक्षण मिती  :</b></td>
                                                                                             <td colspan="10"><b><?php echo convertedcit($nirikshan_date_result->created_date);?></b></td>
                                                                                         </tr>
                                                  <tr>
			  ...
			  <?php }else{// show if maag_id is selected ?>
                                                                                    ...
                                                                                    <table class="table table-bordered">
                                                                                            ...
                                                                                            <?php foreach($result as $data):
                                                                                                $nirikshan_result = Notspentjinsinirakshan::find_by_nirikshan_ids($data->nirikshan_id);
//                                                                                                print_r($data);
                                                                                            ?>
                                                                                            <tr>
                                                                                                <td><?=convertedcit($data->nirikshan_id)?></td>
                                                                                                <td><?=convertedcit($nirikshan_result->created_date)?></td>
                                                                                                <td><a href="jinsinirakshan_kharchaformfillnot.php?nirikshan_id=<?=$data->nirikshan_id?>" class="btn">पुरा विवरण हेर्नुहोस </a></td>
                                                                                            </tr>
                                                                                            <?php endforeach;?>
                                                                                    </table>  
        <?php } ?>
