    	...
    	<div class="">
            <div class="">
                <div class="maincontent">
                    <h2 class="headinguserprofile">मर्मत आदेश  खोज्नुहोस / <a href="marmat_adesh_search.php" class="btn">पछी जानुहोस </a></h2>
                  
                    <div class="OurContentFull">
                    	<h2>मर्मत आदेश खोज्नुहोस	 </h2>
                        <div class="userprofiletable">
                            <a href="dakhila_newAdd1.php" class="btn">OK </a>
                            
                            
                            <div class="myPrint"><a href="marmat_adesh_print_final.php?adesh_no=<?=$_GET['adesh_no']?>" target="_blank">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>
                                    <div class="printPage">
