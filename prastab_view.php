...
//	$datas= Enlist::find_all();
        $profiles = PrastabProfile::find_all();
?>
...
<body>
    ...
    <div id="body_wrap_inner"> 
    	<div class="maincontent">
             <h2 class="headinguserprofile">प्रस्ताब / निर्णय  | <a href="prastab_form.php" class="btn"> थप्नुहोस + </a> | <a href="settings.php" class="btn">पछि जानुहोस</a></h2>
                        ...
                        <div class="userprofiletable">
                        		<span class="myMessage"><?php echo $message;?></span>
                                        <?php foreach($profiles as $profile):
                                                $details = PrastabDetails::find_by_profile_id($profile->id);
                                                $members = MemberInvited::find_by_profile_id_type_id($profile->id,1);
                                            ?>
                                    	...
                                    	<table class="table table-bordered table-hover table-striped">
                                            <tr style="background-color:#9999ff">
                                                ...
                                                <td><a class="btn" href="prastab_edit.php?id=<?=$profile->id?>">Edit<a> <span ><a class="myPrint" target="_blank" href="prastab_print.php?id=<?=$profile->id?>">प्रिन्ट गर्नुहोस</a></span></td>
                                            </tr>
                                            <tr>
