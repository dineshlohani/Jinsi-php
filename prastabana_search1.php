...
<body>
    ...
    <div id="body_wrap_inner"> 
                ...
                <div class="maincontent">
                    <h2 class="headinguserprofile">दर रेट उपलब्ध गराउने बारे ।  <a href="dashboard_prastabana.php" class="btn">पछि जानुहोस </a></h2>
                    <div class="OurContentFull">
                    	<h2>दर रेट उपलब्ध गर्ने सम्न्धमा।</h2>
                        <div class="userprofiletable">
                             ...
                             <table  class="table table-bordered table-responsive td1">
                                ...
                                <tr>
                                   <td><?=convertedcit($i)?></td> 
                                    ...
                                    <td><a href="prastabana_search.php?kharid_id=<?=$data->kharid_id?>" class="btn">पुरा विवरण हेर्नुहोस</a> <?php if(empty($tippani_result)){ ?><a href="prastabana_delete.php?kharid_id=<?=$data->kharid_id?>" class="btn">हटाउनुहोस</a><?php } ?></td>
                                </tr>
                                <?php $i++; endforeach; ?>
                            </table>
                            ...
                            <?php
									...
									<div class="printContent">
                                        ...
                                        <div class="subjectBold letter_subject">बिषय – दर रेट पेश गर्ने सम्बन्धमा ।</div>
                                        <div class="chalanino">
                                        	 श्री <?php echo $enlist_result->name;?>   , <br><?php echo $enlist_result->address;?> । 
                                        </div>
                                        <div class="bankdetails">
                                        	उपरोक्त बिषयमा तपाइको फर्म यस कार्यालयमा सुचिकृत भएकाले नगरपालिकाको लागी तपशिल बमाजिमका सामानहरु आबश्यक भएकाले के कति दररेटमा उपलब्ध गराउन सकिन्छ र समान सप्लाइ गर्न इच्छुक भएमा <?= convertedcit($prastabana->prastabana_entry_date) ?> दिन भित्रमा एस यस पत्रमा उल्लेखित समानहरुको दररेट उपलब्ध गराइदिनु हुन् अनुरोध छ।
                                            <div class="myspacer"></div>
                                        </div>
									  <div class="bankdetails">
