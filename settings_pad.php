...
if(isset($_POST['submit']))
{
    ...
    {
        $data=  Pad::find_by_id($_POST['update_id']);
    }
    else
    {
        $data = new Pad();
	...
	$data->name= $_POST['name'];
       if($data->save()){
        echo alertBox("तह  थप सफल", "settings_pad.php");
        }
...
if(isset($_GET['id']))
{
    $result = Pad::find_by_id($_GET['id']);
}
else
{
    $result = Pad::setEmptyObjects();
}
$office_result=  Pad::find_all();
?>
...
<body>
    ...
    <div id="body_wrap_inner"> 
    	<div class="maincontent">
             <h2 class="headinguserprofile">पद हेर्नुहोस | <a href="settings.php" class="btn">पछि जानुहोस</a></h2>
                 <div class="OurContentFull">
                        ...
                        <div class="userprofiletable">
                            ...
                            <h2 class="headinguserprofile">पद हेर्नुहोस </h2>
                                    <table class="table table-bordered table-hover table-striped">
                                            <tr>&nbsp;</tr>
                                            <tr>
                                            <th class="myCenter">सि. नं .</th>
                                            <th class="myCenter">पदको नाम </th>
                                          ...
                                          <?php $i=1;foreach($office_result as $data): ?>
                                          	<tr>
                                                        ...
                                                        <td class="myCenter"><a href="settings_pad.php?id=<?php echo $data->id; ?>" class="btn">सच्याउनुहोस्</a></td>
                                                    </tr>
