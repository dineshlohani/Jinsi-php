...
<body>
    ...
    <div id="body_wrap_inner"> 
                ...
                <div class="maincontent">
                    <h2 class="headinguserprofile">खर्च हुने सामानको विवरण | <a href="settings_spent_item_add.php" class="btn">खर्च हुने सामानको विवरण थप्नुहोस + </a>||<a href="settings.php" class="btn">पछि जानुहोस  </a></h2>
                        ...
                        <div class="userprofiletable">
							...
							<div class="myMessage"><?php echo $message;?></div>
                                    ...
                                    <?php foreach($item_type as $type):
                                        $datas= Spentitem::find_by_item_type_id($type->id); 
                                    if(!empty($datas))
                                       {    
                                        ?>      
                                          <?php $i=1;foreach($datas as $data): ?>
                                          	 <tr>
                                                        ...
                                                        <td class="myCenter"><?php echo Budgettitle::getName($data->budget_title_id); ?></td>
                                                        <td class="myCenter"><?php echo Unit::getName($data->unit_id); ?></td>
                                                        <td class="myCenter"><a href="settings_spent_item_edit.php?id=<?php echo $data->id; ?>" class="btn">सच्याउनुहोस्</a></td>
                                                    </tr>
