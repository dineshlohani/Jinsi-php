    	...
    	<div class="">
            <div class="">
                <div class="maincontent">
                    <h2 class="headinguserprofile">खर्च भएर नजाने जिन्सी स्टोक हेर्नुहोस / <a class="btn" href="dashboard_stock_check.php">पछाडी  जानुहोस </a> </h2>
                    <div class="OurContentFull">
                    	<h2>खर्च भएर नजाने जिन्सी स्टोक वार्षिक विवरण</h2>
                          ...
                          <form method="get">
                                    <table class="table table-bordered table-responsive">
                                        <tr>
                                            ...
                                            <td>
                                                <select name="fiscal_id" required>
                                                    ...
                                                    <?php foreach ($fiscal_all as $data): ?>
                                                    <option <?php if($data->id==$fiscal_id){echo 'selected="selected"';} ?> value="<?= $data->id ?>"><?= convertedcit($data->year) ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </td>
                                            <th>
                                            ...
                                            <td>
                                                <select name="month_id">
                                                    <option value="">छान्नुहोस्</option>
                                                        <?php foreach ($fiscal_months as $key=>$value): ?> 
                                        ...
                                        <tr>
                                            <td colspan="3">&nbsp;</td>
                                            <td>
                                                <input type="submit" value="हेर्नुहोस्" name="submit">
                                            </td>
                                        </tr>
                  ...
                  <?php if(isset($_GET['month_id'])): ?>                  
                            <div class="myPrint"><a href="stock_not_spent_items_view_print.php?month_id=<?= $_GET['month_id'] ?>&fiscal_id=<?= $_GET['fiscal_id'] ?>" target="_blank">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>
                                          <div class="printPage">
									...
									<div class="subjectBold letter_subject">खर्च भएर नजाने जिन्सी सामानको <?= $fiscal_months[$_GET['month_id']] ?> महिना को आम्दानी खर्च विवरण</div>
...
//                                                  //    print_r($data);exit;
                                                  ...
                                                  // echo $date;exit;
                                                        $item_details = get_item_rate1($data->item_id,2,$data->rate,$end_date);
