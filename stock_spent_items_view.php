    	...
    	<div class="">
            <div class="">
                <div class="maincontent">
                    <h2 class="headinguserprofile">खर्च भएर जाने जिन्सी स्टोक हेर्नुहोस / <a class="btn" href="dashboard_stock_check.php">पछाडी  जानुहोस </a> </h2>
                    <div class="OurContentFull">
                    	<h2>खर्च भएर जाने जिन्सी स्टोक वार्षिक विवरण</h2>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="month_id">
                                                    ...
                                                    <option <?php if($data->id==$fiscal_months) {echo 'selected="selected"';}?> value="<?= $key ?>"><?= $value ?></option>
                                                    <?php endforeach;?>
                                                </select>
                                            </td>
                                        </tr>
                  ...
                  <?php if(isset($_GET['month_id'])): ?>                  
                            <div class="myPrint"><a href="stock_spent_items_view_print.php?month_id=<?= $_GET['month_id'] ?>&fiscal_id=<?= $_GET['fiscal_id'] ?>" target="_blank">प्रिन्ट गर्नुहोस</a></div><div class="myspacer"></div>
                                          <div class="printPage">
